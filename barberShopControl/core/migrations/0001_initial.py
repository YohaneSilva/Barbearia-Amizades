    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('us_perfil', models.CharField(choices=[('C', 'Cliente'), ('E', 'Especialista'), ('A', 'Administrador')], max_length=1)),
                ('us_primeiro_nome', models.CharField(max_length=15)),
                ('us_segundo_nome', models.CharField(max_length=45)),
                ('us_sexo', models.CharField(choices=[('M', 'Masculino'), ('F', 'Feminino')], max_length=1)),
