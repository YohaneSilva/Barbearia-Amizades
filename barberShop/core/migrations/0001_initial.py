# Generated by Django 2.2.12 on 2020-04-26 03:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('us_data_alter', models.DateTimeField(auto_now=True)),
                ('us_situacao_conta', models.BooleanField(null=True, verbose_name='Status da conta')),
                ('us_perfil', models.CharField(choices=[('C', 'Cliente'), ('E', 'Especialista'), ('A', 'Administrador')], max_length=1, null=True, verbose_name='Perfil')),
                ...
                ('us_end_cep', models.CharField(max_length=8, verbose_name='Cep')),
                ('us_end_logradouro', models.CharField(blank=True, max_length=100, verbose_name='Endereço')),
                ('us_end_numero', models.CharField(blank=True, max_length=8, verbose_name='Numero')),
                ('us_end_complemento', models.CharField(blank=True, max_length=100, verbose_name='Complemento')),
                ('us_end_bairro', models.CharField(blank=True, max_length=72, verbose_name='Bairro')),
                ('us_end_cidade', models.CharField(blank=True, max_length=72, verbose_name='Cidade')),
                ('us_end_uf', models.CharField(blank=True, max_length=2, verbose_name='UF')),
            ],
        ),
        migrations.CreateModel(
            name='Servico',
            fields=[
                ...
                ('serv_tempo_duracao', models.TimeField()),
                ('serv_valor', models.DecimalField(decimal_places=2, max_digits=7)),
