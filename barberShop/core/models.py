...
class Usuario(models.Model):
    ...
    us_data_alter = models.DateTimeField(auto_now=True, auto_now_add=False, null=False)
    us_situacao_conta = models.BooleanField(verbose_name= 'Status da conta',default=True, null=True )
    us_perfil = models.CharField(max_length=1, choices=PERFIL_CHOICES,verbose_name= 'Perfil',default='C' ,null=True )
    us_primeiro_nome = models.CharField(max_length=15, verbose_name= 'Primeiro nome')
    us_segundo_nome = models.CharField(max_length=45, verbose_name= 'Segundo nome')
    ...
    us_telefone = models.CharField(max_length=11, verbose_name= 'Telefone')
